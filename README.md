...
This public distribution is maintained by SynteroLink under the JACKSXA GitHub account.

- Public repository: https://github.com/JACKSXA/sub2api
- SynteroLink: https://synterolink.com
- API endpoint example: https://api.synterolink.com/v1

This repository is based on the LGPL-3.0 licensed Sub2API project. See [NOTICE](NOTICE) and [LICENSE](LICENSE) for license and upstream attribution details.

## Ecosystem

Payment, admin, and deployment capabilities are maintained inside this repository. SynteroLink-specific deployment and support information is available at https://synterolink.com.
...
```bash
curl -sSL https://raw.githubusercontent.com/JACKSXA/sub2api/main/deploy/install.sh | sudo bash
```
...
# Uninstall
curl -sSL https://raw.githubusercontent.com/JACKSXA/sub2api/main/deploy/install.sh | sudo bash -s -- uninstall -y
```
...
curl -sSL https://raw.githubusercontent.com/JACKSXA/sub2api/main/deploy/docker-deploy.sh | bash
...
git clone https://github.com/JACKSXA/sub2api.git
cd sub2api/deploy
...
<a href="https://star-history.com/#JACKSXA/sub2api&Date">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=JACKSXA/sub2api&type=Date&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=JACKSXA/sub2api&type=Date" />
   <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=JACKSXA/sub2api&type=Date" />
 </picture>
</a>
