...
この公開版は JACKSXA GitHub アカウントで SynteroLink がメンテナンスしています。

- 公開リポジトリ: https://github.com/JACKSXA/sub2api
- SynteroLink: https://synterolink.com
- API エンドポイント例: https://api.synterolink.com/v1

このリポジトリは LGPL-3.0 ライセンスの Sub2API プロジェクトをベースにしています。ライセンスと上流帰属については [NOTICE](NOTICE) と [LICENSE](LICENSE) を参照してください。

## エコシステム

決済、管理、デプロイ関連の機能はこのリポジトリ内で維持されています。SynteroLink 固有のデプロイとサポート情報は https://synterolink.com を参照してください。
