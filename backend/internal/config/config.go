...
func setDefaults() {
	...
	// Pricing - 默认从 JACKSXA/sub2api 仓库内的公开镜像文件同步模型定价和上下文窗口数据。
	viper.SetDefault("pricing.remote_url", "https://raw.githubusercontent.com/JACKSXA/sub2api/main/backend/resources/model-pricing/model_prices_and_context_window.json")
