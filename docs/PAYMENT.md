...
> **EasyPay provider note**: EasyPay-compatible providers are third-party payment services. Configure only providers you have independently reviewed and contracted with. Do not rely on referral links, promotional claims, or unofficial recommendations when choosing a payment processor.
>
> Please evaluate the security, reliability, fee structure, settlement rules, and legal compliance of any third-party payment provider on your own. This project does not endorse or guarantee any payment provider.
...
If you previously used an external Sub2API-compatible payment system, you can migrate to the built-in payment system:
