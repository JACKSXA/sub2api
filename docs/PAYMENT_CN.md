...
> **易支付服务商说明**：兼容易支付协议的服务商均属于第三方支付服务。请只配置你已经独立审核并正式签约的支付服务商，不要依赖推荐链接、优惠宣传或非官方承诺来选择支付通道。
>
> 支付渠道的安全性、稳定性、手续费、结算规则及合规性请自行鉴别。本项目不对任何第三方支付服务商做担保或背书。
...
如果你之前使用外部的 Sub2API 兼容支付系统，现在可以迁移到内置支付：
